...
contract FlightSuretyData {
    ...
    */   
    function registerAirline(address airline) external onlyParticipantAirlines isCallerAuthorised onlyWhenOperational {
        if (nRegisteredAirlines < 5) {
            ...
            // forbid same airline voting twice for registree
            ...
            // register airline if more than 50% of registered airlines approve it 
    ...
    function creditInsurees(bytes32 flightKey) internal onlyWhenOperational {
        ...
        if (nInsurances > 0) {
            for (uint i = 0; i < nInsurances; i++) {
                ...
                // Check
            //     require(insuranceValue  <= 1 ether, "Insuree can't have insurance value greater than 1");
                // Debit
    ...
    */   
    function fund() public payable onlyRegisteredAirline onlyWhenOperational {
        // CHECKS: ensure that value sent is above deposit
        ...
        // EFFECTS: airline is funded and can participate in insurance 
        airlines[msg.sender].isFunded = true;
        // INTERACTIONS: return back excess of deposit 
